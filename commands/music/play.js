...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if(message.content.includes("https://youtube.com/") ||message.content.includes(" https://www.youtube.com/") || message.content.includes("https://youtu.be.com/") ||message.content.includes("https://youtu.be/")) {
