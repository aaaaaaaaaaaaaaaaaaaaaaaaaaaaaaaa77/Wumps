...
if (channel === null) return;
    ...
    const query = new MessageEmbed()
      .setDescription(`<a:Never:792521914920337469> | You forgot to specify the reason to decline this suggestion!`)
      .setColor("FF2052")
      
    const reply = new MessageEmbed()
      .setDescription(`<a:Kk:792521917507829760> | Successfully declined the Suggestion.`)
      .setColor("00FFFF")
  ...
  return message.channel.send(noMessage);
    ...
    const embed = new MessageEmbed()
      .setDescription(`<a:annonce:820270431083954206> | Your Suggestion as been declined. **[Message Link](https://discord.com/channels/${message.guild.id}/${channel}/${messageID})**`)
      .setColor("BLUE")
      user.send(embed)
